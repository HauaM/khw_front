...
### 주요 기능
- **상담 관리**: 상담 조회, 검색, 상세 보기, 상담 생성, 유사 상담 비교
- **메뉴얼 관리**: 초안 생성, 수정, 검색, 버전 비교, 히스토리 관리
- **검토 워크플로우**: 메뉴얼 검토 요청/승인/반려, 검토 작업 관리
...
│   │   └── dashboard/           # 대시보드 (1개)
│   │
│   ├── components/              # 재사용 컴포넌트 (51개)
│   │   ├── common/              # Spinner, Toast, Pagination, Modal, Icons (9개)
│   │   ├── auth/                # 인증 관련 컴포넌트 (2개)
│   │   ├── consultations/       # 상담 관련 컴포넌트 (10개)
│   │   ├── manuals/             # 메뉴얼 관련 컴포넌트 (10개)
│   │   ├── reviews/             # 검토 관련 컴포넌트 (5개)
│   │   ├── search/              # 검색 폼 (1개)
│   │   ├── table/               # 테이블 컴포넌트 (1개)
│   │   ├── modals/              # 모달 컴포넌트 (1개)
│   │   ├── admin/               # 관리자 컴포넌트 (4개)
│   │   ├── departments/         # 부서 관리 컴포넌트 (3개)
│   │   └── commonCode/          # 공통코드 관리 컴포넌트 (4개)
│   │
│   ├── layouts/                 # 레이아웃 컴포넌트
...
│   │   ├── auth.ts              # 인증 관련 타입
│   │   ├── consultations.ts     # 상담 관련 타입
│   │   ├── manuals.ts           # 메뉴얼 관련 타입
│   │   ├── reviews.ts           # 검토 관련 타입
│   │   ├── departments.ts       # 부서 관련 타입
│   │   ├── users.ts             # 사용자 관련 타입
│   │   ├── api.ts               # API 공통 타입
...
| `/admin/users` | AdminUsersPage | 사용자 관리 (레거시) |
| `/admin/user-management` | UserManagementPage | 사용자 관리 (신규) |
| `/admin/departments` | DepartmentManagementPage | 부서 관리 |
